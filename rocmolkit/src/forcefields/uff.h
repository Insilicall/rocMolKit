...
hipError_t computeGradients(BatchedMolecularDeviceBuffers& molSystemDevice, hipStream_t stream = nullptr);

hipError_t computeGradBlockPerMol(BatchedMolecularDeviceBuffers& molSystemDevice, hipStream_t stream = nullptr);
