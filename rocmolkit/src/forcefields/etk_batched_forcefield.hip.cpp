...
hipError_t ETKBatchedForcefield::computeEnergy(double*        energyOuts,
...
hipError_t ETKBatchedForcefield::computeGradients(double*        grad,
                                                   const double*  positions,
                                                   const uint8_t* activeSystemMask,
                                                   hipStream_t   stream) {
...
hipError_t ETKBatchedForcefield::computePlanarEnergy(double*        energyOuts,
                                                      const double*  positions,
                                                      const uint8_t* activeSystemMask,
                                                      hipStream_t   stream) {
